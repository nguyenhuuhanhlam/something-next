...
export async function POST (req)
{
	...
	const picks = ['code','branchId','branchName','soldById','soldByName','customerCode','customerName','purchaseDate','total','status']

	const response = await fetch(`https://public.kiotapi.com/invoices?pageSize=${pageSize}`, options)
